export const vendorText = [
  {
    name: "BRATHAUS",
    subheading: "Authentic German Sausage.",
    text: [
      `With our Brathaus concept we are bringing authentic German sausages to London over the Christmas period and beyond. We choose only the finest quality sausages that are grilled using a barrel style BBQ for the best flavour. We sell the largest bratwurst in town with a length of 30cm (12”), served in fresh baguette with the option of mustard, ketchup & sauerkraut. We also offer a smaller portion.`,
  ...
  },
  {
    ...
    text: [
      `We love indian food but often it can be very oily which could give you an upset stomach. At Naan Stop we want you to experience a healthy and nutritious meal that respects the comfort of Indian street food. START from scratch with our fresh handmade naan.`,
